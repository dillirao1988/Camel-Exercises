...
within an OSGi container like OSGi. Compare to the camel-exercises-cbr exercise, we use @EndpointInject annotations
...
then please enter this in the Karaf Console:
    ...
    osgi:install -s mvn:com.fusesource.training/camel-exercises-cbr-endpoints/2010.07.12

3) Install it as feature (need to add the features URL ahead of time, please see the camel-exercises-features project)

    features:install camel-exercises-cbr-encpoints
...
For 2) and 3) the input and output directories are now created under for ServiceMix:
    ...
    /target/test-classes/camel-exercises/cbr/[in|out]/[csv|xml]
